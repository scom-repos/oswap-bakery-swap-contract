...
define("@scom/oswap-bakery-swap-contract/contracts/BakeryMaster.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-bakery-swap-contract/contracts/BakeryMaster.json.ts"], function (require, exports, eth_contract_1, BakeryMaster_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-bakery-swap-contract/contracts/BakerySwapRouter.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-bakery-swap-contract/contracts/BakerySwapRouter.json.ts"], function (require, exports, eth_contract_2, BakerySwapRouter_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BakerySwapRouter = void 0;
    class BakerySwapRouter extends eth_contract_2.Contract {
        constructor(wallet, address) {
        ...
        assign() {
            ...
            let addLiquidity_call = async (params, options) => {
                ...
                return {
                    amountA: new eth_contract_2.BigNumber(result.amountA),
                    amountB: new eth_contract_2.BigNumber(result.amountB),
                    liquidity: new eth_contract_2.BigNumber(result.liquidity)
                };
            };
            ...
            let addLiquidityBNB_call = async (params, options) => {
                ...
                return {
                    amountToken: new eth_contract_2.BigNumber(result.amountToken),
                    amountBNB: new eth_contract_2.BigNumber(result.amountBNB),
                    liquidity: new eth_contract_2.BigNumber(result.liquidity)
                };
            };
...
define("@scom/oswap-bakery-swap-contract/contracts/BakeryToken.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-bakery-swap-contract/contracts/BakeryToken.json.ts"], function (require, exports, eth_contract_3, BakeryToken_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BakeryToken = void 0;
    class BakeryToken extends eth_contract_3.Contract {
        constructor(wallet, address) {
        ...
        decodeDelegateVotesChangedEvent(event) {
            ...
            return {
                ...
                previousBalance: new eth_contract_3.BigNumber(result.previousBalance),
        ...
        assign() {
            ...
            let checkpoints_call = async (params, options) => {
                ...
                return {
                    fromBlock: new eth_contract_3.BigNumber(result.fromBlock),
                    votes: new eth_contract_3.BigNumber(result.votes)
                };
            };
